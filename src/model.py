...
class TFIModel:
    ...
    def init_H_bonds(self):
        ...
        for i in range(self.L - 1):
            ...
            if i == 0: # first bond
                gL = self.g
            if i == self.L - 1: # last bond
                gR = self.g
            
            # sigma^i sigma^i+1 = ... sigma^i kron Id .... Id kron sigma^i+1 
            #                   = sigma^i kron sigma^i+1
    ...
    def energy(self, psi):
        ...
        ----------
        psi : MPS
            A matrix product state object with methods like bond_expectation_value.
        """
        assert psi.L == self.L
